...
public class ProjectDto {
    ...
    @NotBlank(message = "content of your project should not be empty!")
    @Schema(description = "project content for posting", required = true)
    private String content;

    private Long views;

    @NotNull(message = "please enter project's approximate start and end date")
    @Schema(description = "project start and end date", required = true)
    private LocalDateTime startDate, endDate;

    private String recruitmentStatus;

    @NotBlank(message = "please enter your email for others to contact you regarding your project")
    @Schema(description = "team host's email", required = true)
