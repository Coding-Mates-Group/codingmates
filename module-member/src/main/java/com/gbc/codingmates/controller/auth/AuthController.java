...
public class AuthController {
    ...
    @Operation(description = "get user default info by token what is generated by server")
    @GetMapping("/oauth2/token/{tokenId}")
    public ResponseEntity getOAuthTokenDetail(@PathVariable String tokenId) {
        return ResponseEntity.ok(
            authService.getAuthTokenDetail(tokenId)
        );
    }
}
